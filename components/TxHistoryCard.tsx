...
type TxItem = {
  hash: string;
  direction: "in" | "out";
  summary: string; // e.g. "Sent 0.02 ETH"
  age: string; // "2h ago"
  status: "success" | "pending" | "failed";
};

export default function TxHistoryCard() {
  ...
  useEffect(() => {
    ...
    const mockTxs: TxItem[] = [
      {
        hash: "0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abc1",
        direction: "out",
        summary: "Sent 0.02 ETH",
        age: "2h ago",
        status: "success",
      },
      {
        hash: "0x987612341234abcdef567890abcdef567890abcdef567890abcdef567890abc",
        direction: "in",
        summary: "Received 15 USDC",
        age: "1d ago",
        status: "success",
      },
      {
        hash: "0x5555aaaa2222bbbb3333cccc4444dddd5555eeee6666ffff7777eeee9999ddd",
        direction: "out",
              ...
              <div className="flex items-start justify-between">
                <div className="flex flex-col">
                  ...
                  <span className="text-[11px] text-gray-500 dark:text-gray-400">
                    {tx.direction === "out" ? "You sent" : "You received"} ·{" "}
                    {tx.age}
                  </span>
                </div>
